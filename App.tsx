...
import { Search, Sparkles, Zap, Download, Loader2, PlusCircle, FileSpreadsheet, FileJson, Table2, X, Rocket } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  const handleSearch = async (e: React.FormEvent) => {
    ...
    setError(null);
    setHasSearched(true);
    // Note: We reset papers on new search, but keep them if loading more.
    setPapers([]); 
    setSynthesis(null);
    setSelectedPaperIds(new Set()); // Reset selections
